...
13. ⏳ **14-day closed-test clock started 2026-08-09** (the day the 12th tester opted in) — runs passively, expected complete **~2026-08-23**. Keep all 12 testers opted in for the full window; if the opted-in count drops below 12 the gate likely re-checks against the day it's back at 12. Nothing to configure in Play Console until then — "Apply for production" unlocks automatically once the window closes.
14. Success metric before investing further: does 7-day retention among app
...
- ⏳ **14-day closed-test window running (2026-08-09 → ~2026-08-23)** — passive, nothing to configure in Play Console. Keep all 12 testers opted in for the full window. "Apply for production" unlocks automatically once it closes. See §6 item 13.
