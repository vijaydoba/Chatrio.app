...
const staticPages = [
  ...
  { loc: "/stories",      lastmod: TODAY, changefreq: "weekly",  priority: "0.8" },
...
/* ── Story pages (React) ── */
const storyPages = storyIds.map((id) => ({
  loc: `/stories/${id}`,
  lastmod: TODAY,
  changefreq: "monthly",
  priority: "0.7",
...
console.log(`✅  sitemap.xml updated — ${staticPages.length} static, ${postPages.length} posts, ${storyPages.length} stories, ${webStoryPages.length} web stories`);
